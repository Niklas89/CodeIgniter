...
<html lang="fr">
  ...
  <body>
    <div class="navbar navbar-expand-lg navbar-dark bg-primary">
      <div class="container">
        <a href="/" class="navbar-brand">Client-crédit</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="navbar-nav"> <!--
            ...
            <li class="nav-item">
              <a class="nav-link" href="/addclient/">Ajouter Client</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/addcredit/">Ajouter Crédit</a>
            </li>
            <!--
            <li class="nav-item">
